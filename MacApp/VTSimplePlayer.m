...
#EXT-X-ENDLIST";
    ...
    NSString *host = [NSString stringWithFormat:@"%@/text", @(8080)];
    NSLog(@"host=====%@", host);
...
//    container.backgroundColor = [UIColor blackColor];
    ...
    self.playerLayer.frame = CGRectMake(0, 0, container.bounds.size.width, container.bounds.size.height);
}
...
-(void)handleShowViewSublayers{
    for (NSView *view in _containerView.subviews) {
